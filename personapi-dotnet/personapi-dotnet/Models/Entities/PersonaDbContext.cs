...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=localhost,1433;Database=persona_db;User Id=sa;Password=Admin123!;TrustServerCertificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Estudio>(entity =>
        {
            entity.HasKey(e => new { e.IdProf, e.CcPer }).HasName("PK__estudios__FB3F71A6F000B05D");
            ...
            entity.HasOne(d => d.CcPerNavigation).WithMany(p => p.Estudios)
                ...
                .HasConstraintName("FK__estudios__cc_per__4E88ABD4");

            entity.HasOne(d => d.IdProfNavigation).WithMany(p => p.Estudios)
                .HasForeignKey(d => d.IdProf)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__estudios__id_pro__4F7CD00D");
        });

        modelBuilder.Entity<Persona>(entity =>
        {
            entity.HasKey(e => e.Cc).HasName("PK__persona__3213666DB322CA06");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__profesio__3213E83F7CC679F7");
        ...
        {
            entity.HasKey(e => e.Num).HasName("PK__telefono__DF908D65BC2344BB");
            ...
            entity.HasOne(d => d.DuenioNavigation).WithMany(p => p.Telefonos)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__telefono__duenio__52593CB8");
        });
